...
function mapInitialValues(initialValues) {
    ...
    return {
        ...
        season: normalizeSeasonValues(initialValues.season),
...
export default function ClothingItemForm({
    ...
    function handleToggle(fieldName, value) {
        ...
        setFormValues((currentValues) => ({
            ...
            [fieldName]:
                fieldName === "season"
                    ? normalizeSeasonValues(
                        normalizedValue === "all_season" || normalizedValue === "all-season"
                            ? ["all-season"]
                            : toggleArrayValue(
                                currentValues[fieldName].filter(
                                    (entry) => entry !== "all-season" && entry !== "all_season",
                                ),
                                normalizedValue,
                            ),
                    )
                    : toggleArrayValue(currentValues[fieldName], normalizedValue),
        }));
    }
    ...
    function applyImageAnalysis(analysis) {
        ...
        setFormValues((currentValues) => ({
            ...
            season: analysis.season ? normalizeSeasonValues(analysis.season) : currentValues.season,
    ...
    async function handleSubmit(event) {
        ...
        formData.append("season", JSON.stringify(normalizeSeasonValues(formValues.season)));
    ...
    return (
        <>
            ...
            <form
                className={previewUrl ? "surface-card form-card has-image-preview" : "surface-card form-card"}
            ...
            >
                ...
                <div className="form-grid">
                    ...
                    <label>
                        ...
                        <div className="chip-grid">
                            {SEASON_OPTIONS.map((option) => {
                                const selected = formValues.season.includes(option.value);
                                return (
                                    <button
                                        key={option.value}
                                        type="button"
                                        className={selected ? "chip-button is-selected" : "chip-button"}
                                        onClick={() => handleToggle("season", option.value)}
                                    >
                                        {option.label}
                                    </button>
                                );
                    ...
                    <div className="field-block full-width">
                        <div className="field-heading field-heading-stack">
                    ...
                    <div className="field-block image-field full-width">
                        ...
                        <div className={previewUrl ? "image-field-row has-preview" : "image-field-row"}>
                            <label className="file-upload-button file-upload-button-primary">
                                <input
                                    type="file"
                            ...
                            {previewUrl ? (
                                <div className="image-preview-card">
                                    <img
                                        ...
                                        src={previewUrl}
                                        alt={imageFile ? "Превью загруженной вещи" : "Текущее изображение вещи"}
                                    />
                    ...
                    <div className="field-block full-width image-analysis-block image-ai-field">
                        <div className="field-heading">
                            ...
                            <label
                                className={
                                    autoRemoveBackground
                                        ? "secondary-button image-toggle-button is-selected"
                                        : "secondary-button image-toggle-button"
                                }
                            >
                                <input
                                    type="checkbox"
